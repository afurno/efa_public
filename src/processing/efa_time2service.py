...
cells_df = cells_df.groupby(["category", "#day_of_the_week", "fake_date", "hour", "area"]).sum()
cells_df = cells_df.reset_index()
cells_df = cells_df[["category", "#day_of_the_week", "fake_date", "hour", "area", "total_volume_per_day_of_the_week"]]
cells_df["time"] = cells_df["fake_date"] + "." + cells_df["#day_of_the_week"].map(str) + "," + cells_df["hour"].map(str)


cells_df = cells_df.pivot(index='time', columns='category', values='total_volume_per_day_of_the_week')
# print cells_df.head()
